...
export const mockTodos: ITodo[] = [
  {
    ...
    days: [
      { date: "2023-09-11", status: true },
      { date: "2023-09-12", status: true },
      { date: "2023-09-13", status: true },
      { date: "2023-09-14", status: false },
      { date: "2023-09-15", status: true },
      { date: "2023-09-16", status: true },
      { date: "2023-09-17", status: null },
    ]
  },
  {
